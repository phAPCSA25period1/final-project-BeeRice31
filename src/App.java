...
public class App {
        ...
        public static void main(String[] args) {
                ...
                // ========== PARTS 2-4: LOOP THROUGH EACH DAY ==========
                while (weeklyTracker.getCurrentDay() < 7) {
                        int dayNum = weeklyTracker.getCurrentDay() + 1;
                        printHeader("DAY " + dayNum + " OF 7 - LOG ACTIVITY");
                        ...
                        printHeader("DAY " + dayNum + " SUMMARY");
                        ...
                        for (WorkoutEntry w : log.getWorkouts()) {
                                if (w.getSets() == 0) {
                                        ...
                                        System.out.println("  - " + w.getType() + " -- " +
                                                        w.getSets() + " sets x " + w.getReps() + " reps, "
                                                        + w.getDurationMinutes() + " min");
                                }
                        }
                        ...
                        for (MacroEntry m : log.getMacros()) {
                                System.out.println("  - " + m.getMealName() + " -- " +
                                                m.getProtein() + "g protein, " + m.getCarbs() + "g carbs, " + m.getFat()
                                                + "g fat");
                        ...
                        printHeader("DAY " + dayNum + " GOAL SCORE");
